...
function updateHeaderProject() {
  document.getElementById("header-title").textContent =
    "Current Project: " + projectArray[currentProjectElement.id].name;
}
...
function createTask(project, title, description, dueDate, priority) {
  ...
  new Task(title, description, dueDate, priority).pushToParentProject(
    projectArray[project].taskArray
  );
  closeModal();
}
